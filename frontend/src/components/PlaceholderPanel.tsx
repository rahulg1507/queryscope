  ...
  return (
    <section className="workspace-card placeholder-card" aria-labelledby={`${kind}-title`}>
      <div className="card-heading compact-heading">
        ...
        <span className="panel-state">WAITING FOR QUERY</span>
      </div>
      <div className="placeholder-content">
        ...
        <p>{isResults ? 'Parse a SQL statement to inspect its abstract syntax tree.' : 'Run a SQL statement to inspect its visual execution plan.'}</p>
      </div>
    </section>
  )
}
